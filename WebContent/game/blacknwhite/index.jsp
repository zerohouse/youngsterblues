...
<body>
	...
	<div class='foot' id="login">
		<div class="foottitle">
			<span id="logintitle">로그인</span><span class="close"></span>
		</div>
	...
	<div class='foot' id="chat">
		<div class="foottitle">
			<span id="chattitle">채팅</span><span class="close"></span>
		</div>
		<ul class="list" id="conversation"></ul>
		<div id="inputarea">
			<input id="data" /> <input type="button" id="datasend" value="말하기"
				class="btn" />
		</div>
	</div>
	...
	<div id="gameContainer" class="foot">
		<div id="warring">
			<font size="6"><br></font>흑과백2<br> <font size="4">게임을
				시작하려면 접속자 목록에서<br> 게임하실분의 이름을 눌러주세요.
			</font>
		</div>
		<div>
		...
		<div id="gameBody">
			...
			<div id="pointWrap">
				<input id="point" placeholder="0" maxlength="2" /> <input
					id="submitpoint" type="button" value="포인트내기" class="btn"
					disabled="disabled" />
			</div>
		</div>
	</div>
	...
	<div class="foot" id='gameinfo'>
		<div class="foottitle">
			게임방법<span class="close"></span>
		</div>
		<div style="text-align: center; margin-top: 40px;">
			99포인트를 9라운드에 분배하여 대결<br> <strong>5라운드를 먼저 가져가는 플레이어가
				승리.</strong>
		</div>
		<iframe class="embed-responsive-item" scrolling="no"
			src="//www.youtube.com/embed/eb5cGFRrmsg" frameborder="0"
			allowfullscreen=""
			style="width: 100%; padding-top: 30px; height: 420px; bottom: 0; position: absolute;"></iframe>
		<br>
	</div>
	...
	<c:if test="${not empty sessionScope.user}">
		<script>
		login("${sessionScpe.user.id}","${sessionScpe.user.name}");		
		</script>
	</c:if>
